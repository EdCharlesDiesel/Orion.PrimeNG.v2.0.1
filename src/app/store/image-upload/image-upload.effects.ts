        ...
        return this.actions$.pipe(
            ...
            switchMap(({ file }) =>
                this.imageUploadService.uploadImage(file).pipe(
                    ...
                    catchError((error) => of(ImageUploadActions.uploadImageFailure({ error: error.message })))
                )
            )
        );
    });
        ...
        this.actions$.pipe(
            ...
            switchMap(() =>
                this.imageUploadService.getImages().pipe(
                    ...
                    catchError((error) => of(ImageUploadActions.loadImagesFailure({ error: error.message })))
                )
            )
        )
    );
